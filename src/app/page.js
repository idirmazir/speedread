    ...
    <div className="min-h-screen text-[#e4e4e7] overflow-x-hidden" style={{ backgroundColor: '#09090b', fontFamily: font }}>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrollY > 40 ? 'backdrop-blur-xl' : ''}`} style={{ borderBottom: scrollY > 40 ? '1px solid #27272a' : '1px solid transparent', backgroundColor: scrollY > 40 ? 'rgba(9,9,11,0.85)' : 'transparent' }}>
        <div className="max-w-5xl mx-auto px-5 sm:px-6 py-4 flex items-center justify-between">
          <div className="text-[24px] sm:text-[26px] tracking-tight"><span className="font-light">Flash</span><span className="text-emerald-400 font-semibold">Read</span></div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div className="space-y-6 sm:space-y-7">
              ...
              <p className="text-base sm:text-lg text-[#71717a] font-light leading-relaxed max-w-md">
                RSVP technology eliminates eye movement overhead. Your brain processes text at <span className="text-[#e4e4e7] font-medium">2–3× normal speed</span>. Upload PDFs, paste a URL, or drop in any text.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { t: 'PDF, DOCX & URL Import', d: 'Upload lecture slides, journal articles, textbook chapters — or paste any article URL.', i: '📄' },
              { t: 'Reading Analytics', d: 'Track words read, sessions completed, WPM averages, and study streaks over time.', i: '📊' },
              { t: 'Comprehension Recall', d: 'Built-in recall prompts at intervals and after each session to strengthen retention.', i: '💡' },
              { t: 'Speed Ramp', d: 'Start slow, gradually accelerate. Your brain adapts naturally to faster speeds.', i: '⚡' },
              { t: '6 Themes & Fonts', d: 'Emerald, Midnight, Parchment, Rosé, Ocean, Noir — plus dyslexia-friendly fonts.', i: '🎨' },
              { t: 'Document Library', d: 'Save to your cloud library. Resume reading across any device, right where you left off.', i: '📚' },
              { t: 'Progress Tracking', d: 'Auto-saves every 10 seconds. See completion percentage and time remaining.', i: '✓' },
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="rounded-xl p-4 sm:p-5 transition-all duration-200 hover:scale-[1.01]" style={{ backgroundColor: '#18181b', border: '1px solid #27272a' }}>
      ...
      <section id="pricing" className="py-16 sm:py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            {/* Free */}
            <div className="rounded-xl p-6 sm:p-7" style={{ backgroundColor: '#18181b', border: '1px solid #27272a' }}>
            ...
            {/* Pro */}
            <div className="relative rounded-xl p-6 sm:p-7 shadow-lg" style={{ backgroundColor: '#18181b', border: '1px solid rgba(52,211,153,0.25)', boxShadow: '0 0 40px rgba(52,211,153,0.05)' }}>
              ...
              <a href="/app" className="block w-full py-2.5 text-center bg-emerald-500 hover:bg-emerald-400 rounded-lg text-[12px] font-semibold text-black shadow-lg transition-all hover:scale-[1.01] min-h-[40px] flex items-center justify-center">Start Free Trial</a>
            </div>
          </div>
        </div>
      </section>
